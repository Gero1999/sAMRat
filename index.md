...
If you use sAMRat in your research, please cite:

**For sAMRat:**
```
Rodriguez GJ (2024). sAMRat: Shiny Antimicrobial Resistance (AMR) Analysis Tool. 
R package version 0.1.0. https://github.com/Gero1999/sAMRat
```
