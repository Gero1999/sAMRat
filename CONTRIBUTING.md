...
## Quick start
- Fork the repository and create a branch named `X-feature/your-short-desc` or `X-fix/your-short-desc`. Replace `X` with the respective issue number.
- Make small, focused commits with clear messages.
- Open a pull request (PR) against the `main` branch. Describe the problem, your approach, and any testing you ran.
...
### Tests
- Tests live under `tests/testthat/`. Add tests for new behavior and ensure existing tests still pass.
...
- If you modify exported functions or add new ones, update roxygen documentation and rebuild the NAMESPACE:
...
## Code of conduct
Please follow the project's code of conduct (be respectful and constructive). If the project does not yet include a `CODE_OF_CONDUCT.md`, follow GitHub's default community guidelines.

## Questions or contact
For questions or help getting started, open an issue or email the package maintainer listed in `DESCRIPTION`.

Thanks for helping improve sAMRat — contributions are welcome and appreciated!
